...
const ILS_PROJECTS = [
  {
    ...
    tagline: "SHRM's lead commercial interface. Maturity score, to action plan, to simulation.",
    oneLiner: "HR-X Solutions Hub is the Studio's lead revenue vehicle and the commercial interface for the Intelligence Layer Studio. A three-tier enterprise platform — Diagnostic, Prescriptive, Predictive — that tells an organization where their HR function stands, what to do about it, and lets them simulate what happens if they act. Built on the HR-X Assessment, the SHRM BASK, 330,000+ members of workforce data, and — at Tier 3 — the VoW Synthetic digital twin.",
    classification: "Enterprise B2B Intelligence Platform · Lead Revenue Vehicle",
    status: "active",
    ...
    kpis: [
      { n: "$15K",   l: "Tier 1 — Diagnostic maturity score + benchmark panel" },
      { n: "$75K",   l: "Tier 2 — Prescriptive Priority Index + BASK roadmap" },
      { n: "$150K",  l: "Tier 3 — Predictive simulation on VoW digital twin" },
      { n: "95 / 71", l: "Assessment items · subpractice areas benchmarked" },
    ],
    modes: [
...
const ILS_RESEARCH = [
  { date: "April 2026", project: "kcde",  kind: "Architecture",
    title: "A phased, portable, model-agnostic architecture for HR reasoning infrastructure",
    body: "Why ILS builds on Google Cloud in Phases 0–1 and keeps the model layer pluggable — Claude, Gemini, open-source, specialized tabular models. Microsoft Fabric enters the picture only when Phase 2 touchpoint integration demands it. Portability across enterprise stacks is a design principle, not a side effect." },
